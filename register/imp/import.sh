...
docker-compose exec web php register/imp/imp.lijsten.php > output/output-lijstenB.html
docker-compose exec web php register/imp/imp.recensent.php > output/output-recensenten.html
